    ...
    <section id="welcome" className="section welcome" ref={sectionRef}>
      <div className="container">
        <div className="section-header">
          <h2 className="section-title">{t('welcome.title', 'Welcome to BIRD Lab for your research')}</h2>
        ...
        <div className="welcome-content">
          <div className="welcome-grid">
            <div className="welcome-card mission">
              ...
              <h3>{t('welcome.mission.title', 'Our Mission')}</h3>
              <p>
                {t(
                  'welcome.mission.text',
            ...
            <div className="welcome-card vision">
              ...
              <h3>{t('welcome.vision.title', 'Our Vision')}</h3>
              <p>
                {t(
                  'welcome.vision.text',
            ...
            <div className="welcome-card values">
              ...
              <h3>{t('welcome.values.title', 'Our Values')}</h3>
              <p>
                {t(
                  'welcome.values.text',
